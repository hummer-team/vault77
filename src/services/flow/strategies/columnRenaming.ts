 ...
 * When a column appears in more than one table, it is aliased as "tableName.columnName".
 ...
 * 2. If a column appears in ≥ 2 tables → alias as "tableName.columnName".
 ...
 * ]);
 * renameMap.get('main_table_1')?.get('total_amount')  // → 'main_table_1.total_amount'
 * renameMap.get('main_table_2')?.get('total_discount') // → 'main_table_2.total_discount'
 *
